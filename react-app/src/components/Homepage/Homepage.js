  ...
  return (
    <div className="homepage">
      <div className="homepage-hero-div">
        ...
        <h2 className="homepage-hero-description">Where will you go and what will you share about it? Will you stumble upon your new favorite cafe, take a hike through the woods, or seredipitously find just what you are looking for? Select your mission and let's gooooo!</h2>
      </div>
